...
public final class FileQuarantineManager {
    ...
    // TODO: Add Java Docs Explaning that only one instance of a nested class in
    // FileQuarantineManager is allowed.
    /// Therefore , only one instance running if this class is the only thing that
    // will work.
